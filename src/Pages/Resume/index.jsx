...
const experience = [
  {
    ...
    responsibilities: [
      { name: "Frontend development according to the requirements." },
      { name: "Fixing Cascading style sheets." },
      {
        name: "Design and developed dashboard as well as client side section.",
      },
      { name: "Dynamic UI and development according to the requirement’s." },
    ],
  },
];
...
function Resume() {
  return (
    <div className="text-white flex flex-col gap-5">
      ...
      <div className="">
        <a
          href="/assets/resume/Ibnul-Ashir_CV.pdf"
          download
